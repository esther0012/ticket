  ...
  <body>
    <nav class="navbar navbar-dark bg-dark" style="height: 100px;">
        <div class="container-fluid">
          ...
          <li class="nav-item">
            <a class="nav-link active" style="color: white; height: 1%; margin-bottom: 10%;"><div id="data-hora"></div>
              <script defer>
                  const zeroFill = n => {
                      return ('0' + n).slice(-2);
                  }
      ...
      <br>
      <p>Responda em suporte técnico através deste canal.</p>
      ...
      <table class="table table-striped table-bordered">
        ...
        <tbody>
          ...
          <tr onclick="document.location = 'ticketcon.html';">
            ...
            <th class="concluido">Concluído</th>
            <td>Não baixa a atualização</td>
          </tr>
          <tr onclick="document.location = 'ticketand.html';">
            ...
            <td>Não consigo acessar o satmob</td>
          </tr>
    ...
    <div style="text-align: center; margin-top: 6%;">
      <button type="button" class="btn btn-dark" style="width: 5%;" data-bs-toggle="modal" data-bs-target="#exampleModal">
        Sair
      </button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-secondary" onclick="location.href='index.php'">Sim</button>
            </div>
          </div>
        </div>
      </div>
